<?php
    ...
    $page_result = page($conn,'select * from user',"id",1,15,$page_now_page,$page_totalPage);
?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">系统管理员</h4>
                                </div>
                            </div>
                        </div>
                        <?Vnotifications()?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="mb-4">
                                                    <a href="./api.php?state=addUser">
                                                    <button type="button" class="btn btn-light waves-effect waves-light"><i class="bx bx-plus me-1"></i> 添加管理员</button>
                                                    </a>
                                                </div>
                                            </div>
                                                    ...
                                                    <form method="get" action="./search.php">
                                                        <div class="form-group m-0">
                                                            <div class="input-group">
                                                                <input name="search" style="display: none;" value="user" />
